...
#include "kOmegaSSTLMInternalBlend_NP.H"
#include "fvOptions.H"
#include "bound.H"
...
tmp<volScalarField> kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::F1
(
...
) const
{
    ...
    return max(kOmegaSSTInternalBlend_NP<BasicTurbulenceModel>::F1(CDkOmega), F3); //modif rebe
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSSTInternalBlend_NP<BasicTurbulenceModel>::Pk(G);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *kOmegaSSTInternalBlend_NP<BasicTurbulenceModel>::epsilonByk(F1, gradU);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::Fthetat
(
...
kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::ReThetac() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::kOmegaSSTLMInternalBlend_NP
(
...
:
    kOmegaSSTInternalBlend_NP<BasicTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicTurbulenceModel>
bool kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::read()
{
    if (kOmegaSSTInternalBlend_NP<BasicTurbulenceModel>::read())
    {
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMInternalBlend_NP<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    // Correct k and omega
    kOmegaSSTInternalBlend_NP<BasicTurbulenceModel>::correct();
