...
#include "kOmegaSSTBaseDeltaBlendClean.H"
#include "fvOptions.H"
#include "bound.H"
#include "wallDist.H"  
...
tmp<volScalarField> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::F1
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::F2() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::F3() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::F23() const
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::correctNut
(
...
template<class BasicEddyViscosityModel>
Foam::tmp<Foam::volScalarField> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::S2
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::Pk
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::epsilonByk
(
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::GbyNu0
(
    const volTensorField& gradU,
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::Rk
(
	const volTensorField& gradU,
    const volSymmTensorField& PolyRT
) const
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::GbyNu
(
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::kSource() const
{
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>::New
    (
        omega_,
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::Qsas
(
    const volScalarField::Internal& S2,
...
template<class BasicEddyViscosityModel>
kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::kOmegaSSTBaseDeltaBlendClean
(
    const word& type,
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::setDecayControl
(
...
template<class BasicEddyViscosityModel>
bool kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::read()
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaBlendClean<BasicEddyViscosityModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    string WhichFeatures_; 
	this->coeffDict().lookup("WhcihFeatures") >> WhichFeatures_;


    //#include "/home/rebecca29/OpenFOAM/rebecca29-v2306/src/TurbulenceModels/turbulenceModels/Base/kOmegaSSTDeltaBlendClean/Calculate_Features.C"
    
    if (WhichFeatures_ == "Ling")
    	{
    	#include "/home/mciarlatani/OpenFOAM/mciarlatani-v2306/src/TurbulenceModels/turbulenceModels/Base/Calculate_Features_Ling.C"
    	}
    else if (WhichFeatures_=="LingPOD")
    	{
    	#include "/home/mciarlatani/OpenFOAM/mciarlatani-v2306/src/TurbulenceModels/turbulenceModels/Base/Calculate_Features_LingPOD.C"
    	}
    else if (WhichFeatures_=="soufiane")
    	{
    	#include "/home/mciarlatani/OpenFOAM/mciarlatani-v2306/src/TurbulenceModels/turbulenceModels/Base/Calculate_Features_soufiane.C"
    	}
    
    else
    	{
    	Info << "Warning ! no features selected !!";
    	}
	
	Switch Blending_; 
	this->coeffDict().lookup("Blending") >> Blending_;
	if (Blending_ == true){
	string MLmodel_FW_; this->coeffDict().lookup("MLmodel_FW") >> MLmodel_FW_;
	
	Info << "Internal blending : Run python code to Predict weights by " << MLmodel_FW_ << endl;
	std::string command1 = "python3 predict_weights.py " + MLmodel_FW_; // + " " + WhichFeatures_;
	system(command1.c_str());
	 }
    
//    wbD1.correctBoundaryConditions();
//    wbD2.correctBoundaryConditions();
//    wbD3.correctBoundaryConditions();
//    wR1.correctBoundaryConditions();
//    wR2.correctBoundaryConditions();
//    wR3.correctBoundaryConditions();
