...
#include "kOmegaSSTLMInternalBlend.H"
#include "fvOptions.H"
#include "bound.H"
...
tmp<volScalarField> kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::F1
(
...
) const
{
    ...
    return max(kOmegaSSTInternalBlend<BasicTurbulenceModel>::F1(CDkOmega), F3); //modif rebe
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSSTInternalBlend<BasicTurbulenceModel>::Pk(G);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *kOmegaSSTInternalBlend<BasicTurbulenceModel>::epsilonByk(F1, gradU);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::Fthetat
(
...
kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::ReThetac() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::kOmegaSSTLMInternalBlend
(
...
:
    kOmegaSSTInternalBlend<BasicTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicTurbulenceModel>
bool kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::read()
{
    if (kOmegaSSTInternalBlend<BasicTurbulenceModel>::read())
    {
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMInternalBlend<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    // Correct k and omega
    kOmegaSSTInternalBlend<BasicTurbulenceModel>::correct();
