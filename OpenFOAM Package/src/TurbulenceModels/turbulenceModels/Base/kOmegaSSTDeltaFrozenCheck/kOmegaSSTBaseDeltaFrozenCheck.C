...
#include "kOmegaSSTBaseDeltaFrozenCheck.H"
#include "fvOptions.H"
#include "bound.H"
#include "wallDist.H"
...
tmp<volScalarField> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::F1
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::F2() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::F3() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::F23() const
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::correctNut
(
...
template<class BasicEddyViscosityModel>
Foam::tmp<Foam::volScalarField> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::S2
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::Pk
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::epsilonByk
(
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::GbyNu0
(
    const volTensorField& gradU,
...
) const
{
    ...
    (
        ...
        //gradU && ( bijDeltaFrozen_ / (this->nut()+this->nutSmall()) )  
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::Rk
(
	const volTensorField& gradU,
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::GbyNu
(
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::kSource() const
{
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>::New
    (
        omega_,
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::Qsas
(
    const volScalarField::Internal& S2,
...
template<class BasicEddyViscosityModel>
kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::kOmegaSSTBaseDeltaFrozenCheck
(
    const word& type,
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::setDecayControl
(
...
template<class BasicEddyViscosityModel>
bool kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::read()
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaFrozenCheck<BasicEddyViscosityModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
	...
	Info << "Inside Frozen kOmegaBase Check"<< endl;
