...
#include "kOmegaSSTBaseDeltaFeatures.H"
#include "fvOptions.H"
#include "bound.H"
#include "wallDist.H"
...
tmp<volScalarField> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::F1
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::F2() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::F3() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::F23() const
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::correctNut
(
...
template<class BasicEddyViscosityModel>
Foam::tmp<Foam::volScalarField> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::S2
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::Pk
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::epsilonByk
(
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::GbyNu0
(
    const volTensorField& gradU,
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::Rk
(
	const volTensorField& gradU,
    const volSymmTensorField& PolyRT
) const
{
    ...
    (
        IOobject::scopedName(this->type(), "Rk"),
        2.* this->k_ * ReskOmegaOn2k_ //does not work well
        //ReskOmega_
    );
    }
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::GbyNu
(
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::kSource() const
{
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>::New
    (
        omega_,
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::Qsas
(
    const volScalarField::Internal& S2,
...
template<class BasicEddyViscosityModel>
kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::kOmegaSSTBaseDeltaFeatures
(
    const word& type,
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::setDecayControl
(
...
template<class BasicEddyViscosityModel>
bool kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::read()
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaFeatures<BasicEddyViscosityModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    ReskOmega_ = tgradU() && TwokbDeltaR();
    ReskOmegaOn2k_ =  ReskOmega_ / (2. * k_);
    
    ReskOmega_.write();
    ReskOmegaOn2k_.write();
