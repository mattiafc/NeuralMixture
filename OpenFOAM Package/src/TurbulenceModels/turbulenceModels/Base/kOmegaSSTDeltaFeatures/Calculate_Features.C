...
dimensionedScalar min12("min12",dimensionSet(0,1,-2,0,0,0,0),1e-12);//1e-3);

dimensionedScalar cstS("cstS",dimensionSet(0,0,-2,0,0,0,0),1e-12);//1e-3);
...
dimensionedScalar gradPmin("gradPmin",dimensionSet(0,2,-3,0,0,0,0),1e-12);//1e-4);//1e-15);
