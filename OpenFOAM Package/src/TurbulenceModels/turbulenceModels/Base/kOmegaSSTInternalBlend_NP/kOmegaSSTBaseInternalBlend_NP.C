...
#include "kOmegaSSTBaseInternalBlend_NP.H"
#include "fvOptions.H"
#include "bound.H"
#include "wallDist.H"  
...
tmp<volScalarField> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::F1
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::F2() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::F3() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::F23() const
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::correctNut
(
...
template<class BasicEddyViscosityModel>
Foam::tmp<Foam::volScalarField> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::S2
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::Pk
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::epsilonByk
(
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::GbyNu0
(
    const volTensorField& gradU,
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::Rk
(
	const volTensorField& gradU,
    const volSymmTensorField& PolyRT
) const
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::GbyNu
(
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::kSource() const
{
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>::New
    (
        omega_,
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::Qsas
(
    const volScalarField::Internal& S2,
...
template<class BasicEddyViscosityModel>
kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::kOmegaSSTBaseInternalBlend_NP
(
    const word& type,
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::setDecayControl
(
...
template<class BasicEddyViscosityModel>
bool kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::read()
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseInternalBlend_NP<BasicEddyViscosityModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
//    const surfaceScalarField& phi_ = this->phi_;
	...
	//{
    Info << "calculate Ling Features NP" << endl;
    #include "/home/mciarlatani/OpenFOAM/mciarlatani-v2306/src/TurbulenceModels/turbulenceModels/Base/Calculate_Features_Ling_NP.C"
    //}	
	// Updates invariants
    this->IvList(this->U_);
...
//    ReskOmega_.write();
    ...
    // 2. Production term (Direct field assignment)
    Prodk_.ref() = Pk(G);
    ...
    {
        word rhoName_ = ("Rho");
        tmp<volScalarField> rhot_ = U.db().lookupObject<volScalarField>(rhoName_);    

        gradRho_ = fvc::grad(rhot_);
        magGradRho_ = mag(gradRho_);
    }

    // 4. Divergence assignment
    absDivU_.ref() = fvc::div(this->phi()); // Assuming divU comes from the flux phi
