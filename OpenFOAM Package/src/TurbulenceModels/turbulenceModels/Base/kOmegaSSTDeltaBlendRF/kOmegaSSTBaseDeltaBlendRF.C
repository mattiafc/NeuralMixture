...
#include "kOmegaSSTBaseDeltaBlendRF.H"
#include "fvOptions.H"
#include "bound.H"
#include "wallDist.H"  
...
tmp<volScalarField> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::F1
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::F2() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::F3() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::F23() const
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::correctNut
(
...
template<class BasicEddyViscosityModel>
Foam::tmp<Foam::volScalarField> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::S2
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::Pk
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::epsilonByk
(
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::GbyNu0
(
    const volTensorField& gradU,
...
*/
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::Rk
(
	const volTensorField& gradU,
    const volSymmTensorField& PolyRT
) const
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::GbyNu
(
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::kSource() const
{
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>::New
    (
        omega_,
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::Qsas
(
    const volScalarField::Internal& S2,
...
template<class BasicEddyViscosityModel>
kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::kOmegaSSTBaseDeltaBlendRF
(
    const word& type,
...
:
   ...
   TwokbDelta_
    ...
    (
        ...
        this->mesh_ //0. * ( bijDelta_ && fvc::grad(this->U_) )//
    ),
    ReskOmegaOn2k_
    (
        IOobject
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::setDecayControl
(
...
template<class BasicEddyViscosityModel>
bool kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::read()
{
...
template<class BasicEddyViscosityModel>
void kOmegaSSTBaseDeltaBlendRF<BasicEddyViscosityModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    //#include "/home/rebecca29/OpenFOAM/rebecca29-v2306/src/TurbulenceModels/turbulenceModels/Base/kOmegaSSTDeltaBlendRF/Calculate_Features.C"
    
    #include "/home/mciarlatani/OpenFOAM/mciarlatani-v2306/src/TurbulenceModels/turbulenceModels/Base/Calculate_Features.C"
    

	
    string predictWeightsBy_; this->coeffDict().lookup("predictWeightsBy") >> predictWeightsBy_;
    //Info << "Random Forest - Predict weights" << endl;
    // concatenate Features for the current time, and predict weights
    // assign the weights to the internal fields of w_k and correct boundary conditions
    Info << "Predict weights by "<< predictWeightsBy_ << endl;
    std::string command1 = "python3 Predict_Blending_weights_by.py " + predictWeightsBy_;
